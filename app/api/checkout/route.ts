      ...
      line_items: [
        {
          price_data: {
            currency: "usd",
            product_data: {
              name: `${plan.name} Plan - ${plan.credits} Event ${plan.credits === 1 ? 'Credit' : 'Credits'}`,
              description: `Purchase ${plan.credits} event ${plan.credits === 1 ? 'credit' : 'credits'} for Eventify`,
            },
